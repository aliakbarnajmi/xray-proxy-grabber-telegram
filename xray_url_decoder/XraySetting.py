...
class UpgradeSettingsVless:
    path: str
    host: str

    def __init__(self, path: str = None, host=None) -> None:
        self.path = path if path is not None else "/"
        self.host = host if host is not None else ""

class XhttpSettingsVless:
    path: str
    host: str
    mode: str
    def __init__(self, path: str = None, host=None, mode = None) -> None:
        self.path = path if path is not None else "/"
        self.host = host if host is not None else ""
        self.mode = "auto"
        accepted_mode = ["auto", "packet-up", "stream-up", "stream-one"]
        if mode in accepted_mode:
            self.mode = mode
...
class StreamSettings:
    ...
    httpupgradeSettings = UpgradeSettingsVless
    xhttpSettings = XhttpSettingsVless
    ...
    def __init__(self, network: str, security: str, ws_settings: WsSettingsVless = None, upgrade_settings: UpgradeSettingsVless = None,
        ...
        if upgrade_settings is not None:
            self.httpupgradeSettings = upgrade_settings
        if xhttp_settings is not None:
            self.xhttpSettings = xhttp_settings
